    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Phone Images</h1>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{phoneName} — Images</h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/30 border overflow-hidden">
        <div className="px-6 py-4 border-b bg-gray-50 dark:bg-gray-900">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Upload Image</h2>
        ...
        <div className="p-6">
          <div
            className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20/30 transition-all cursor-pointer"
          ...
          >
            ...
            {uploading ? (
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">JPG, PNG, WebP, AVIF, GIF, SVG, HEIC</p>
              </div>
            )}
          </div>
        </div>
              ...
              {images.map((img) => (
                <div
                  ...
                  className={`relative group rounded-xl overflow-hidden border-2 ${
                    mainImage === img.url ? "border-blue-500 ring-2 ring-blue-200" : "border-gray-200 dark:border-gray-700"
                  }`}
                >
