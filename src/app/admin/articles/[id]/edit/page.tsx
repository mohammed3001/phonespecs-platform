    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/admin/articles" className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-gray-500 dark:text-gray-400">
        ...
        <div className="flex items-center gap-2">
          <button onClick={handleDelete} className="text-red-600 hover:bg-red-50 dark:bg-red-900/20 px-3 py-2 rounded-lg text-sm font-medium flex items-center gap-1.5">
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border p-5">
              <label className="text-sm font-medium text-gray-700 dark:text-gray-200 mb-2 block">Slug</label>
              <input
                type="text"
                value={form.slug}
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl border p-5">
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Publish</h3>
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-xs font-medium border transition-colors ${
                        form.tagIds.includes(tag.id)
                          ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 border-blue-300"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border p-5">
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Featured Image</h3>
              <input
                type="text"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border p-5">
              ...
              <div className="space-y-3">
                <div>
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-200 mb-1">Meta Title</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-200 mb-1">Meta Description</label>
                  <textarea
