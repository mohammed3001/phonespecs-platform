    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage advertising campaigns, budgets, and performance</p>
        </div>
        <Link
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl border p-4">
          <p className="text-xs font-medium text-gray-500 uppercase">Total Campaigns</p>
        ...
        <div className="bg-white rounded-xl border p-4">
          ...
          <p className="text-2xl font-bold text-gray-900 mt-1">${totalSpent.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
        </div>
        <div className="bg-white rounded-xl border p-4">
          <p className="text-xs font-medium text-gray-500 uppercase">Total Budget</p>
          <p className="text-2xl font-bold text-gray-900 mt-1">${totalBudget.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
        </div>
      </div>
                  ...
                  return (
                    <>
                      <tr key={campaign.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">
                          <p className="text-sm text-gray-700">{campaign.advertiser.name}</p>
                        ...
                        <td className="px-4 py-3">
                          <div className="text-xs space-y-0.5">
                            <p className="text-gray-700">{campaign._count.impressions.toLocaleString()} impr.</p>
                            <p className="text-gray-700">{campaign._count.clicks.toLocaleString()} clicks</p>
