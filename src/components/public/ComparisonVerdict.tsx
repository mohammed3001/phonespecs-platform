    ...
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
      ...
      <div className={`px-6 py-5 ${
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="font-bold text-gray-900 text-lg">Verdict</h3>
        </div>
        {verdict.overallWinner === "tie" ? (
        ...
        <p className="text-sm text-gray-600 mt-1">{verdict.overallExplanation}</p>
      </div>
            ...
            <div key={key} className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                {isTie ? (
                  ...
                  <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${
                    phone1Wins ? "text-blue-600 bg-blue-50" : "text-violet-600 bg-violet-50"
                  }`}>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-semibold text-gray-500 w-8">{cat.phone1Score}%</span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-semibold text-gray-500 w-8">{cat.phone2Score}%</span>
                </div>
              </div>
