...
export const phones: Phone[] = [
  ...
  },
  {
    ...
    price: { amount: 499, currency: 'USD', label: 'Official' },
    priceUsd: 499,
    images: [
      { id: 'img11', url: 'https://placehold.co/400x500/1a1a2e/e0e0e0?text=Nothing+Phone+3', thumbUrl: 'https://placehold.co/200x250/1a1a2e/e0e0e0?text=NP3', alt: 'Nothing Phone (3)', isPrimary: true, sortOrder: 0 },
    ],
    keySpecs: {
      os: 'Android 15',
      storage: '256GB / 512GB',
    ...
    specGroups: [
      { category: 'General', categorySlug: 'general', icon: 'mdi:information-outline', specs: [{ id: 'np1', name: 'Brand', slug: 'brand', value: 'Nothing', isHighlight: false, isComparable: true }] },
      { category: 'Display', categorySlug: 'display', icon: 'mdi:cellphone', specs: [{ id: 'np5', name: 'Size', slug: 'display_size', value: '6.7 inches', isHighlight: true, isComparable: true }] },
      { category: 'Memory', categorySlug: 'memory', icon: 'mdi:memory', specs: [{ id: 'np15', name: 'RAM', slug: 'ram', value: '12GB', isHighlight: true, isComparable: true }] },
      { category: 'Camera', categorySlug: 'camera', icon: 'mdi:camera-outline', specs: [{ id: 'np18', name: 'Main Camera', slug: 'main_camera', value: '50+50MP', isHighlight: true, isComparable: true }] },
      { category: 'Battery', categorySlug: 'battery', icon: 'mdi:battery-high', specs: [{ id: 'np21', name: 'Capacity', slug: 'battery', value: 'Li-Ion 5500mAh', isHighlight: true, isComparable: true }] },
    ],
    reviews: [],
    popularity: 82,
    viewCount: 35000,
  ...
  },
  {
    ...
    price: { amount: 1799, currency: 'USD', label: 'Expected' },
    priceUsd: 1799,
    images: [
      { id: 'img12', url: 'https://placehold.co/400x500/1a1a2e/e0e0e0?text=Galaxy+Z+Fold7', thumbUrl: 'https://placehold.co/200x250/1a1a2e/e0e0e0?text=ZFold7', alt: 'Samsung Galaxy Z Fold 7', isPrimary: true, sortOrder: 0 },
    ],
    keySpecs: {
      os: 'Android 16',
      storage: '256GB / 512GB / 1TB',
      ram: '16GB',
      mainCamera: '200+12+10MP',
      frontCamera: '12MP + 4MP UDC',
      display: '7.6" + 6.2" Dynamic AMOLED 2X',
      battery: 'Li-Ion 5000mAh',
      fingerprint: 'Side-mounted',
      charger: '45W + 15W Wireless',
      resistanceRating: 'IPX8',
      wifi: 'Wi-Fi 7',
      glassProtection: 'Gorilla Glass Armor 2',
      bluetooth: '5.4',
    },
    specGroups: [
      { category: 'General', categorySlug: 'general', icon: 'mdi:information-outline', specs: [{ id: 'zf1', name: 'Brand', slug: 'brand', value: 'Samsung', isHighlight: false, isComparable: true }] },
      { category: 'Display', categorySlug: 'display', icon: 'mdi:cellphone', specs: [{ id: 'zf5', name: 'Size', slug: 'display_size', value: '7.6 + 6.2 inches', isHighlight: true, isComparable: true }] },
      { category: 'Memory', categorySlug: 'memory', icon: 'mdi:memory', specs: [{ id: 'zf15', name: 'RAM', slug: 'ram', value: '16GB', isHighlight: true, isComparable: true }] },
      { category: 'Camera', categorySlug: 'camera', icon: 'mdi:camera-outline', specs: [{ id: 'zf18', name: 'Main Camera', slug: 'main_camera', value: '200+12+10MP', isHighlight: true, isComparable: true }] },
      { category: 'Battery', categorySlug: 'battery', icon: 'mdi:battery-high', specs: [{ id: 'zf21', name: 'Capacity', slug: 'battery', value: 'Li-Ion 5000mAh', isHighlight: true, isComparable: true }] },
    ],
    reviews: [],
    popularity: 88,
    viewCount: 55000,
  },
  {
    ...
    price: { amount: 1399, currency: 'USD', label: 'Expected' },
    priceUsd: 1399,
    images: [
      { id: 'img13', url: 'https://placehold.co/400x500/333333/e0e0e0?text=iPhone+17+Pro+Max', thumbUrl: 'https://placehold.co/200x250/333333/e0e0e0?text=i17PM', alt: 'Apple iPhone 17 Pro Max', isPrimary: true, sortOrder: 0 },
    ],
    keySpecs: {
      os: 'iOS 19',
      storage: '256GB / 512GB / 1TB',
      ram: '12GB',
      mainCamera: '48+48+12MP',
      frontCamera: '24MP',
      display: '6.9" Super Retina XDR OLED',
      battery: 'Li-Ion 5200mAh',
      fingerprint: 'Under display, ultrasonic',
      charger: '45W MagSafe + 25W Qi2',
      resistanceRating: 'IP69',
      wifi: 'Wi-Fi 7',
      glassProtection: 'Ceramic Shield Ultra',
      bluetooth: '5.4',
    },
    specGroups: [
      { category: 'General', categorySlug: 'general', icon: 'mdi:information-outline', specs: [{ id: 'ip17_1', name: 'Brand', slug: 'brand', value: 'Apple', isHighlight: false, isComparable: true }] },
      { category: 'Display', categorySlug: 'display', icon: 'mdi:cellphone', specs: [{ id: 'ip17_5', name: 'Size', slug: 'display_size', value: '6.9 inches', isHighlight: true, isComparable: true }] },
      { category: 'Memory', categorySlug: 'memory', icon: 'mdi:memory', specs: [{ id: 'ip17_15', name: 'RAM', slug: 'ram', value: '12GB', isHighlight: true, isComparable: true }] },
      { category: 'Camera', categorySlug: 'camera', icon: 'mdi:camera-outline', specs: [{ id: 'ip17_18', name: 'Main Camera', slug: 'main_camera', value: '48+48+12MP', isHighlight: true, isComparable: true }] },
      { category: 'Battery', categorySlug: 'battery', icon: 'mdi:battery-high', specs: [{ id: 'ip17_21', name: 'Capacity', slug: 'battery', value: 'Li-Ion 5200mAh', isHighlight: true, isComparable: true }] },
    ],
    reviews: [],
    popularity: 96,
    viewCount: 89000,
  ...
  },
  {
    ...
    price: { amount: 699, currency: 'USD', label: 'Official' },
    priceUsd: 699,
    images: [
      { id: 'img14', url: 'https://placehold.co/400x500/660066/e0e0e0?text=Edge+60+Ultra', thumbUrl: 'https://placehold.co/200x250/660066/e0e0e0?text=E60U', alt: 'Motorola Edge 60 Ultra', isPrimary: true, sortOrder: 0 },
    ],
    keySpecs: {
      os: 'Android 15',
      storage: '256GB / 512GB',
      ram: '12GB',
      mainCamera: '200+50+12MP',
      frontCamera: '32MP',
      display: '6.7" 1220x2712 pOLED',
      battery: 'Si-C 5500mAh',
      fingerprint: 'Under display, ultrasonic',
      charger: '125W TurboPower + 50W Wireless',
      resistanceRating: 'IP68',
      wifi: 'Wi-Fi 7',
      glassProtection: 'Gorilla Glass Victus 2',
      bluetooth: '5.4',
    ...
    specGroups: [
      { category: 'General', categorySlug: 'general', icon: 'mdi:information-outline', specs: [{ id: 'me1', name: 'Brand', slug: 'brand', value: 'Motorola', isHighlight: false, isComparable: true }] },
      { category: 'Display', categorySlug: 'display', icon: 'mdi:cellphone', specs: [{ id: 'me5', name: 'Size', slug: 'display_size', value: '6.7 inches', isHighlight: true, isComparable: true }] },
      { category: 'Memory', categorySlug: 'memory', icon: 'mdi:memory', specs: [{ id: 'me15', name: 'RAM', slug: 'ram', value: '12GB', isHighlight: true, isComparable: true }] },
      { category: 'Camera', categorySlug: 'camera', icon: 'mdi:camera-outline', specs: [{ id: 'me18', name: 'Main Camera', slug: 'main_camera', value: '200+50+12MP', isHighlight: true, isComparable: true }] },
      { category: 'Battery', categorySlug: 'battery', icon: 'mdi:battery-high', specs: [{ id: 'me21', name: 'Capacity', slug: 'battery', value: 'Si-C 5500mAh', isHighlight: true, isComparable: true }] },
    ],
    reviews: [],
    popularity: 79,
    viewCount: 28000,
  },
  {
    ...
    priceUsd: 999,
    images: [
      { id: 'img15', url: 'https://placehold.co/400x500/cc0000/e0e0e0?text=Huawei+Pura+80+Pro', thumbUrl: 'https://placehold.co/200x250/cc0000/e0e0e0?text=P80Pro', alt: 'Huawei Pura 80 Pro', isPrimary: true, sortOrder: 0 },
    ],
    keySpecs: {
      os: 'HarmonyOS 5',
      storage: '256GB / 512GB / 1TB',
      ram: '16GB',
      mainCamera: '50+48+48MP XMAGE',
      frontCamera: '13MP 3D ToF',
      display: '6.8" 1260x2844 LTPO OLED',
      battery: 'Si-C 5900mAh',
      fingerprint: 'Under display, ultrasonic 3D',
      charger: '100W Wired + 80W Wireless',
      resistanceRating: 'IP68',
      wifi: 'Wi-Fi 6E',
      glassProtection: 'Kunlun Glass 2',
      bluetooth: '5.3',
    },
    specGroups: [
      { category: 'General', categorySlug: 'general', icon: 'mdi:information-outline', specs: [{ id: 'hp1', name: 'Brand', slug: 'brand', value: 'Huawei', isHighlight: false, isComparable: true }] },
      { category: 'Display', categorySlug: 'display', icon: 'mdi:cellphone', specs: [{ id: 'hp5', name: 'Size', slug: 'display_size', value: '6.8 inches', isHighlight: true, isComparable: true }] },
      { category: 'Memory', categorySlug: 'memory', icon: 'mdi:memory', specs: [{ id: 'hp15', name: 'RAM', slug: 'ram', value: '16GB', isHighlight: true, isComparable: true }] },
      { category: 'Camera', categorySlug: 'camera', icon: 'mdi:camera-outline', specs: [{ id: 'hp18', name: 'Main Camera', slug: 'main_camera', value: '50+48+48MP XMAGE', isHighlight: true, isComparable: true }] },
      { category: 'Battery', categorySlug: 'battery', icon: 'mdi:battery-high', specs: [{ id: 'hp21', name: 'Capacity', slug: 'battery', value: 'Si-C 5900mAh', isHighlight: true, isComparable: true }] },
    ],
    reviews: [],
    popularity: 84,
    viewCount: 42000,
